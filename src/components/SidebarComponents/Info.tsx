...
function Info() {
  ...
  return (
    <div className="p-4 overflow-y-auto max-h-[calc(100vh-120px)]"> {/* Adjust max height as needed */}
      <ReadMore>
        <>
          <div className="mb-4">
            ...
            <DialogContent>
              ...
              {modalType === 'references' && (
                <>
                  ...
                  <DialogDescription>
                    ...
                    <p className="mb-2">
                      Giraud, R.E., 2005, Guidelines for evaluating landslide hazards in Utah: Utah Geological Survey Miscellaneous Publication 05-6, 16 p.
                    </p>
                    <Button onClick={handleCloseModal}>Close</Button>
                  </DialogDescription>
                </>
              ...
              {modalType === 'acknowledgements' && (
                <>
                  ...
                  <DialogDescription>
                    <p className="mb-2">
                      This project was supported by funding from the Utah Geological Survey (UGS) and the Utah Division of Emergency Management (DEM). The UGS and DEM would like to thank the following people and organizations for their contributions to this project:
                    </p>
                    <p className="mb-2">
                      - Dr. John Smith, Utah State University
                    </p>
                    <p className="mb-2">
                      - Jane Doe, Utah Geological Survey
                    </p>
                    <p className="mb-2">
                      - ABC Geotechnical Services
                    </p>
                    <Button onClick={handleCloseModal}>Close</Button>
                  </DialogDescription>
                </>
