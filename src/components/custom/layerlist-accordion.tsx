...
// import { useGroupLayerVisibility } from '@/hooks/use-custom-layerlist';
...
//             console.log('Zooming to layer', currentLayer);

//             handleGroupLayerVisibilityToggle(layer.parent.layer.id);
//             updateLayer(layer => {
//                 layer.visible = true;
//             });
