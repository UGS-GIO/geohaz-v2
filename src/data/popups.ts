// NOTE: These popuptemplates are no longer being used. The ones that were in use have been converted to react components and are now in the src/components/custom/popups directory.
// The following code is kept here for reference in case we ever need to use any of the templates that hadn't been converted to react components.
