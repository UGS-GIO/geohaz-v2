...
const floodHazardsConfig: LayerProps = {
    ...
    visible: false,
    layers: [floodAndDebrisWMSConfig, groundwaterSusConfig],
};
...
const earthquakesConfig: LayerProps = {
    ...
    visible: true,
    layers: [groundshakingWMSConfig, liquefactionWMSConfig, faultRuptureConfig, qFaultsWMSConfig],
};
...
const soilHazardsConfig: LayerProps = {
    ...
    visible: true,
    layers: [eolianSusConfig, solubleSoilConfig, bedrockPotConfig, tectonicDefConfig, radonSusceptibilityWMSConfig, pipingAndErosionWMSConfig, karstFeaturesWMSConfig, erosionHazardZoneWMSConfig, expansiveSoilRockWMSConfig, earthFissureWMSConfig, corrosiveSoilRockWMSConfig, collapsibleSoilWMSConfig, calicheWMSConfig],
};
